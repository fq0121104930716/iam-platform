...
public class UserExternalLogin {
    ...
    /**
     * Link an external login provider to a user.
     */
    public static UserExternalLogin link(Long userId, String provider,
        ...
        Guard.positive(userId.intValue(), "User ID must be positive");
        ...
        return UserExternalLogin.builder()
                .userId(userId)
                .provider(provider)
