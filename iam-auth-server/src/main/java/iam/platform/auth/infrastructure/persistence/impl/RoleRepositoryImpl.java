...
import iam.platform.auth.domain.model.entity.Role;
import iam.platform.common.model.enums.RoleType;
import iam.platform.auth.domain.repository.RoleRepository;
import iam.platform.auth.infrastructure.persistence.entity.RolePO;
import iam.platform.auth.infrastructure.persistence.repository.RoleJpaRepository;
