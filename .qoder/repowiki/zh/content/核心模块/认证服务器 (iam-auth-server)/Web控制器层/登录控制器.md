...
- [TenantContext.java](file://iam-auth-server/src/main/java/iam/platform/auth/domain/service/context/TenantContext.java)
...
- [TenantContext.java:7-44](file://iam-auth-server/src/main/java/iam/platform/auth/domain/service/context/TenantContext.java#L7-L44)
...
- [TenantAwareAuthenticationFilter.java:1-68](file://iam-auth-server/src/main/java/iam/platform/auth/interfaces/web/filter/TenantAwareAuthenticationFilter.java#L1-L68)
...
- [TenantContext.java:1-45](file://iam-auth-server/src/main/java/iam/platform/auth/domain/service/context/TenantContext.java#L1-L45)
...
- [TenantAwareAuthenticationFilter.java:21-67](file://iam-auth-server/src/main/java/iam/platform/auth/interfaces/web/filter/TenantAwareAuthenticationFilter.java#L21-L67)
...
- [TenantAwareAuthenticationFilter.java:28-44](file://iam-auth-server/src/main/java/iam/platform/auth/interfaces/web/filter/TenantAwareAuthenticationFilter.java#L28-L44)
- [TenantInterceptor.java:23-42](file://iam-auth-server/src/main/java/iam/platform/auth/infrastructure/security/TenantInterceptor.java#L23-L42)
- [TenantContext.java:39-43](file://iam-auth-server/src/main/java/iam/platform/auth/domain/service/context/TenantContext.java#L39-L43)
...
图表来源
- [TenantAwareAuthenticationFilter.java:28-44](file://iam-auth-server/src/main/java/iam/platform/auth/interfaces/web/filter/TenantAwareAuthenticationFilter.java#L28-L44)
- [TenantAwareAuthenticationFilter.java:49-66](file://iam-auth-server/src/main/java/iam/platform/auth/interfaces/web/filter/TenantAwareAuthenticationFilter.java#L49-L66)
